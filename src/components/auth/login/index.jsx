    ...
    return (
        <div className="bg-[#F7F8F3] min-h-screen min-w-screen flex items-center justify-center">
            ...
            <div className="p-4 border rounded-lg shadow-md bg-white max-w-md min-w-sm mx-auto pt-15">
                <h2 className="text-3xl text-black font-bold mb-6 mt-4 text-center">Welcome Back!</h2>
                <form onSubmit={onSubmit} className="space-y-4">
                    ...
                    <button
                        ...
                        className={`btn-primary w-full mb-4 ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300'}`}
                    >
                ...
                <button
                    ...
                    className={`mt-4 w-full flex items-center justify-center gap-x-3 py-2.5 btn-primary mb-4  ${isSigningIn ? 'cursor-not-allowed' : 'hover:bg-gray-100 transition duration-300 active:bg-gray-100'}`}>
